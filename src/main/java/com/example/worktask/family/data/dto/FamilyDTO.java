...
public class FamilyDTO {
    ...
    public FamilyDTO(Long id, String familyName, Integer nrOfAdults, Integer nrOfChildren, Integer nrOfInfants) {
        this.id = id;
    ...
    public FamilyDTO(String familyName, Integer nrOfAdults, Integer nrOfChildren, Integer nrOfInfants) {
        this.familyName = familyName;
        this.nrOfAdults = nrOfAdults;
        this.nrOfChildren = nrOfChildren;
        this.nrOfInfants = nrOfInfants;
